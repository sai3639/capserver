...
def adaptive_sampling(audio_data, sample_rate, baud_rate):
    samples_per_bit = int(sample_rate / baud_rate)
    return [audio_data[i:i + samples_per_bit] for i in range(0, len(audio_data), samples_per_bit//2)]
...
def fft_analysis(samples, sample_rate, target_freqs):
    """FFT analysis to get the magnitude at specific target frequencies."""
